        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
			<div class="box">							
				<div class="icon">
					...
					<div class="info">
						<?php
							$javaproject = $_GET['javaproject'];
						?>
						<div class="row black">
							<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"><h3 class="title"><?php echo basename($javaproject,'.json');?> --- Project Details</h3></div>
